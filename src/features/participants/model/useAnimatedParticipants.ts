/**
 * useAnimatedParticipants
 *
 * 책임:
 * - participant list 변경을 enter/stable/exit animation phase로 투영
 *
 * 하지 않는 것:
 * - participant 정렬/점수 계산
 * - animation CSS 정의
 */
...
import type { AnimatedParticipantItem } from '@/features/participants/model/participantPresentation'
